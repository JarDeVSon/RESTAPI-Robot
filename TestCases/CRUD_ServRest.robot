...
POST On Session Request
    ${BODY}=        Create Dictionary       nome=Pipeline 2   email=pipeline2@qa.com.br    password=teste      administrador=true
...
PUT On Session Request
    ${BODY}=        Create Dictionary       nome=AAlterado    email=putmethod@qa.com.br       password=teste      administrador=true
    ${HEADERS}=     Create Dictionary       Content-Type=application/json
