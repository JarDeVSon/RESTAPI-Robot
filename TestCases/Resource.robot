...
POST On Session Request
    ${DATA_BODY}=   Create Dictionary       nome=teste123    email=teste123@qa.com.br    password=teste      administrador=true
...
PUT On Session Request
    ${BODY}=        Create Dictionary       nome=alt123    email=alt123@qa.com.br       password=teste      administrador=true
    ${HEADERS}=     Create Dictionary       Content-Type=application/json
