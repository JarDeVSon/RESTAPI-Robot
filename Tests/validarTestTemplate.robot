...
Scenario - 01 - (POST) Validar usuario inserido no ServRest
    ...
    Quando executo uma requisicao POST na API "batata", "a34sasa4214a123a4sas@qa.com", "teste", "true"
...
Scenario Outline 01 - (POST) Validar response das informações do usuario inserido no ServRest
    ...
    bora    lets31gaasas4123314o@qa.com.br     faker       true            201             Cadastro realizado com sucesso
